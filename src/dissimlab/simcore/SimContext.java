...
public class SimContext {
	...
	private SimContextEntity contextSimEntity; // Common simEntity for general/common model/context stateChanges
	...
	private SimContext(String name, SimManager simModel) {
		...
		this.contextSimEntity = new SimContextEntity(this);
	}
	...
	public SimContextEntity getContextSimEntity() {
		return contextSimEntity;
	}
